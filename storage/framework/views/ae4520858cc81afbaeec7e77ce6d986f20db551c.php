                    ...
                    <accordian :title="'<?php echo e(__('admin::app.settings.channels.general')); ?>'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group"  :class="[errors.has('hostname') ? 'has-error' : '']">
                                ...
                                <input class="control" v-validate="''" id="hostname" name="hostname" value="<?php echo e(old('hostname')); ?>" placeholder="https://www.example.com"/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\weavers-v1\vendor\bagisto\bagisto\packages\Webkul\Admin\src\Providers/../Resources/views/settings/channels/create.blade.php ENDPATH**/ ?>