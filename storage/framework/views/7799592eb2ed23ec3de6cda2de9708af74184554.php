...
?>
    ...
    <?php elseif(isset($billing) && $billing): ?>
        ...
        <?php if(auth()->guard('customer')->check()): ?>
            ...
            ?>
        <?php endif; ?>
    <?php endif; ?><?php /**PATH /home/suhailinfo/domains/suhail.info/public_html/resources/themes/velocity/views/checkout/onepage/customer-new-form.blade.php ENDPATH**/ ?>