                    ...
                    <accordian :title="'<?php echo e(__('admin::app.catalog.categories.general')); ?>'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('<?php echo e($locale); ?>[name]') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="name" name="<?php echo e($locale); ?>[name]" value="<?php echo e(old($locale)['name'] ?? ($category->translate($locale)['name'] ?? '')); ?>" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.categories.name')); ?>&quot;" v-slugify-target="'slug'"/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suhailinfo/domains/suhail.info/public_html/vendor/bagisto/bagisto/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/categories/edit.blade.php ENDPATH**/ ?>